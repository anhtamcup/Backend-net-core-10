        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestBody2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ResponseBody2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CallbackRoutingLogs", x => x.ID);
                });

            migrationBuilder.CreateTable(
                name: "CallbackRoutings",
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CallbackRoutings", x => x.ID);
                });
